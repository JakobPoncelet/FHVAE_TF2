...
## COMMAND PARAMETERS:
/users/spraak/spchdata/timit/CDdata /users/spraak/spchdata/timit/CDdata/timit/doc --ftype fbank --out_dir /esat/spchdisk/scratch/jponcele/fhvae/datasets/timit_np_fbank
"""
