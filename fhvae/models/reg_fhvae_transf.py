...
class RegFHVAEtransf(tf.keras.Model):
    ...
    def __init__(self, z1_dim=32, z2_dim=32, nmu2=5000, z1_nlabs={}, z2_nlabs={}, x_rhus=[256, 256], \
                 d_model=512, num_enc_layers=4, num_heads=8, dff=2048, pe_max_len=8000, rate=0.1, \
                 mu_nl=None, logvar_nl=None, tr_shape=(20, 80), bs=256, alpha_dis=1.0, alpha_reg_b=1.0, \
                 alpha_reg_c=1.0, name="autoencoder", **kwargs):
        ...
        #init net
        self.encoder = Encoder(self.z1_dim, self.z2_dim, self.d_model, self.num_enc_layers, self.num_heads, self.dff, \
                               self.pe_max_len, self.rate, self.bs, self.tr_shape, self.mu_nl, self.logvar_nl)
